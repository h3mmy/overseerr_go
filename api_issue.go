...
type IssueAPI interface {
	...
	*/
	IssueCommentCommentIdDelete(ctx context.Context, commentId string) IssueAPIIssueCommentCommentIdDeleteRequest

	// IssueCommentCommentIdDeleteExecute executes the request
	IssueCommentCommentIdDeleteExecute(r IssueAPIIssueCommentCommentIdDeleteRequest) (*http.Response, error)
	...
	*/
	IssueCommentCommentIdGet(ctx context.Context, commentId string) IssueAPIIssueCommentCommentIdGetRequest

	// IssueCommentCommentIdGetExecute executes the request
	//  @return IssueComment
	IssueCommentCommentIdGetExecute(r IssueAPIIssueCommentCommentIdGetRequest) (*IssueComment, *http.Response, error)
	...
	*/
	IssueCommentCommentIdPut(ctx context.Context, commentId string) IssueAPIIssueCommentCommentIdPutRequest

	// IssueCommentCommentIdPutExecute executes the request
	//  @return IssueComment
	IssueCommentCommentIdPutExecute(r IssueAPIIssueCommentCommentIdPutRequest) (*IssueComment, *http.Response, error)
	...
	*/
	IssueCountGet(ctx context.Context) IssueAPIIssueCountGetRequest

	// IssueCountGetExecute executes the request
	//  @return IssueCountGet200Response
	IssueCountGetExecute(r IssueAPIIssueCountGetRequest) (*IssueCountGet200Response, *http.Response, error)
	...
	*/
	IssueGet(ctx context.Context) IssueAPIIssueGetRequest

	// IssueGetExecute executes the request
	//  @return IssueGet200Response
	IssueGetExecute(r IssueAPIIssueGetRequest) (*IssueGet200Response, *http.Response, error)
	...
	*/
	IssueIssueIdCommentPost(ctx context.Context, issueId float32) IssueAPIIssueIssueIdCommentPostRequest

	// IssueIssueIdCommentPostExecute executes the request
	//  @return Issue
	IssueIssueIdCommentPostExecute(r IssueAPIIssueIssueIdCommentPostRequest) (*Issue, *http.Response, error)
	...
	*/
	IssueIssueIdDelete(ctx context.Context, issueId string) IssueAPIIssueIssueIdDeleteRequest

	// IssueIssueIdDeleteExecute executes the request
	IssueIssueIdDeleteExecute(r IssueAPIIssueIssueIdDeleteRequest) (*http.Response, error)
	...
	*/
	IssueIssueIdGet(ctx context.Context, issueId float32) IssueAPIIssueIssueIdGetRequest

	// IssueIssueIdGetExecute executes the request
	//  @return Issue
	IssueIssueIdGetExecute(r IssueAPIIssueIssueIdGetRequest) (*Issue, *http.Response, error)
...
Requires the `MANAGE_ISSUES` permission or `ADMIN`.
	...
	*/
	IssueIssueIdStatusPost(ctx context.Context, issueId string, status string) IssueAPIIssueIssueIdStatusPostRequest

	// IssueIssueIdStatusPostExecute executes the request
	//  @return Issue
	IssueIssueIdStatusPostExecute(r IssueAPIIssueIssueIdStatusPostRequest) (*Issue, *http.Response, error)
	...
	*/
	IssuePost(ctx context.Context) IssueAPIIssuePostRequest

	// IssuePostExecute executes the request
	//  @return Issue
	IssuePostExecute(r IssueAPIIssuePostRequest) (*Issue, *http.Response, error)
}
