...
type MoviesAPI interface {
	...
	*/
	MovieMovieIdGet(ctx context.Context, movieId float32) MoviesAPIMovieMovieIdGetRequest

	// MovieMovieIdGetExecute executes the request
	//  @return MovieDetails
	MovieMovieIdGetExecute(r MoviesAPIMovieMovieIdGetRequest) (*MovieDetails, *http.Response, error)
	...
	*/
	MovieMovieIdRatingsGet(ctx context.Context, movieId float32) MoviesAPIMovieMovieIdRatingsGetRequest

	// MovieMovieIdRatingsGetExecute executes the request
	//  @return MovieMovieIdRatingsGet200Response
	MovieMovieIdRatingsGetExecute(r MoviesAPIMovieMovieIdRatingsGetRequest) (*MovieMovieIdRatingsGet200Response, *http.Response, error)
	...
	*/
	MovieMovieIdRatingscombinedGet(ctx context.Context, movieId float32) MoviesAPIMovieMovieIdRatingscombinedGetRequest

	// MovieMovieIdRatingscombinedGetExecute executes the request
	//  @return MovieMovieIdRatingscombinedGet200Response
	MovieMovieIdRatingscombinedGetExecute(r MoviesAPIMovieMovieIdRatingscombinedGetRequest) (*MovieMovieIdRatingscombinedGet200Response, *http.Response, error)
	...
	*/
	MovieMovieIdRecommendationsGet(ctx context.Context, movieId float32) MoviesAPIMovieMovieIdRecommendationsGetRequest

	// MovieMovieIdRecommendationsGetExecute executes the request
	//  @return DiscoverMoviesGet200Response
	MovieMovieIdRecommendationsGetExecute(r MoviesAPIMovieMovieIdRecommendationsGetRequest) (*DiscoverMoviesGet200Response, *http.Response, error)
	...
	*/
	MovieMovieIdSimilarGet(ctx context.Context, movieId float32) MoviesAPIMovieMovieIdSimilarGetRequest

	// MovieMovieIdSimilarGetExecute executes the request
	//  @return DiscoverMoviesGet200Response
	MovieMovieIdSimilarGetExecute(r MoviesAPIMovieMovieIdSimilarGetRequest) (*DiscoverMoviesGet200Response, *http.Response, error)
}
